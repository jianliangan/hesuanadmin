...
public class PlanDivisionController extends BaseController<PlanDivision> {
    ...
    public void filterUpdateRow(String pre, String cmd, PlanDivision row, HttpServletRequest request) {
        ...
        if (pre.equals("pre")) {
            if (cmd.equals("add")) {
                ...
                IMyService.commonComputPrice(planDivisionMachineMapper, row, false, "plan");
                ...
                IMyService.commonComputPrice(planDivisionMachineMapper, row, true, "plan");
        ...
        if (err == null) {
            pageData =
                    ITreeService.<PlanDivision>getTreeWithPrice(
                            projectId, ownId, planDivisionService, projectService, treeServiceConvert, searchStr);
        }
