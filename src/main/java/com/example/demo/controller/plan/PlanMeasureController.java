...
public class PlanMeasureController extends BaseController<PlanMeasure> {
    ...
    @Autowired
    private IPlanMeasureService planMeasureService;
    @Autowired
    ...
    @Autowired
    PlanMeasureMachineMapper planMeasureMachineMapper;
    ...
    public void filterUpdateRow(String pre, String cmd, PlanMeasure row, HttpServletRequest request) {
        ...
        if (pre.equals("pre")) {
            if (cmd.equals("add")) {
                IMyService.commonComputPrice(planMeasureMachineMapper, row, false, "plan");
                ...
                IMyService.commonComputPrice(planMeasureMachineMapper, row, true, "plan");
        ...
        if (err == null) {
            pageData =
                    ITreeService.<PlanDivision>getTreeWithPrice(
                            projectId, ownId, planMeasureService, projectService, treeServiceConvert, searchStr);
        }
