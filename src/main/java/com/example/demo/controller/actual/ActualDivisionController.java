...
public class ActualDivisionController extends BaseController<ActualDivision> {
    ...
    @Autowired
    ActualDivisionMachineMapper actualDivisionMachineMapper;
    ...
    public void filterUpdateRow(String pre, String cmd, ActualDivision row, HttpServletRequest request) {
        ...
        if (pre.equals("pre")) {
            if (cmd.equals("add")) {
                IMyService.commonComputPrice(actualDivisionMachineMapper, row, false, "actual");
                ...
                IMyService.commonComputPrice(actualDivisionMachineMapper, row, true, "actual");
        ...
        if (err == null) {
            pageData =
                    ITreeService.<ActualDivision>getTreeWithPrice(
                            projectId, ownId, actualDivisionService, projectService, treeServiceConvert, searchStr);
        }
