...
@RestController
@RequestMapping("/report/supplyunit")
public class ReportSupplyUnitController extends BaseController<TotalDivision> {
    ...
    public ResData getTree2(HttpServletRequest request) {
        ...
        String supplyUnitId =
                (request.getParameter("supplyUnitId") == null)
                        ? ""
                        : request.getParameter("supplyUnitId"); //
        String cmd =
