...
public class BudgetMeasureMachineController extends BaseController<BudgetMeasureMachine> {
    ...
    @Autowired
    private IBudgetMeasureMachineService budgetMeasureMachineService;
    @Autowired
...
/////
    ...
    public void filterUpdateRow(String pre, String cmd, BudgetMeasureMachine row, HttpServletRequest request) {
