...
public class BudgetMeasureController extends BaseController<BudgetMeasure> {
    ...
    public void filterUpdateRow(String pre, String cmd, BudgetMeasure row, HttpServletRequest request) {
        ...
        if (pre.equals("pre")) {
            if (cmd.equals("add")) {
                IMyService.commonComputPrice(budgetMeasureMachineMapper, row, false, "budget");
                ...
                IMyService.commonComputPrice(budgetMeasureMachineMapper, row, true, "budget");
        ...
        if (err == null) {
            pageData =
                    ITreeService.<BudgetMeasure>getTreeWithPrice(
                            projectId, ownId, budgetMeasureService, projectService, treeServiceConvert, searchStr);
        }
