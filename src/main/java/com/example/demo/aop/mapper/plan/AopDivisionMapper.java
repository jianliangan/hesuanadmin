...
@Aspect
@Component
public class AopDivisionMapper {
    ...
    public void beforeUpdateByIdPlan(JoinPoint joinPoint) {
        ...
        extendInventory(listInventoryMapper, (PlanDivision) signatureArgs[0], "jiahua", "division", "edit");
    }

    @Before("insertPlan()")
    public void beforeInsertPlan(JoinPoint joinPoint) {
        Object[] signatureArgs = joinPoint.getArgs();
        extendInventory(listInventoryMapper, (PlanDivision) signatureArgs[0], "jiahua", "division", "add");
    }
    ...
    public void beforeUpdateByIdActual(JoinPoint joinPoint) {
        Object[] signatureArgs = joinPoint.getArgs();
        extendInventory(listInventoryMapper, (ActualDivision) signatureArgs[0], "shiji", "division", "edit");
    }

    @Before("insertPlan()")
    public void beforeInsertActual(JoinPoint joinPoint) {
        Object[] signatureArgs = joinPoint.getArgs();
        extendInventory(listInventoryMapper, (ActualDivision) signatureArgs[0], "shiji", "division", "add");
    }
    ...
    public void beforeUpdateByIdBudget(JoinPoint joinPoint) {
        Object[] signatureArgs = joinPoint.getArgs();
        extendInventory(listInventoryMapper, (BudgetDivision) signatureArgs[0], "yusuan", "division", "edit");
    }

    @Before("insertPlan()")
    public void beforeInsertBudget(JoinPoint joinPoint) {
        Object[] signatureArgs = joinPoint.getArgs();
        extendInventory(listInventoryMapper, (BudgetDivision) signatureArgs[0], "yusuan", "division", "add");
    }

    private void extendInventory(BaseMapper mapper, BaseReport entity, String type, String name, String cmd) {
        if (entity == null)
            return;
        ...
        listInventory.setTableName(name);
        listInventory.setCmd(cmd);
